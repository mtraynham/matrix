...
(function (global){
"use strict";
var $__lib_47_ndarray_47_NDArray__;
var $__0 = ($__lib_47_ndarray_47_NDArray__ = require("./lib/ndarray/NDArray"), $__lib_47_ndarray_47_NDArray__ && $__lib_47_ndarray_47_NDArray__.__esModule && $__lib_47_ndarray_47_NDArray__ || {default: $__lib_47_ndarray_47_NDArray__}),
    NDArray = $__0.NDArray,
...
},{"./lib/ndarray/NDArray":2}],2:[function(require,module,exports){
"use strict";
...
var NDArray = function NDArray() {
  ...
  var shape = arguments[1] !== (void 0) ? arguments[1] : null;
  var stride = arguments[2] !== (void 0) ? arguments[2] : null;
  var offset = arguments[3] !== (void 0) ? arguments[3] : -1;
  this.data = data;
  this.shape = shape || [data.length];
  if (!stride) {
    var d = this.shape.length;
    stride = new Array(d);
    for (var i = d - 1,
        sz = 1; i >= 0; --i) {
      stride[i] = sz;
...
($traceurRuntime.createClass)(NDArray, {
  ...
  get: function() {
    ...
    var index = this.index(indices);
    return index > -1 ? this.data[index] : null;
  },
  set: function(value) {
    for (var indices = [],
        $__4 = 1; $__4 < arguments.length; $__4++)
      indices[$__4 - 1] = arguments[$__4];
    var index = this.index(indices);
    if (index > -1) {
...
($traceurRuntime.createClass)(Utils, {}, {
  nullToZero: function(datum) {
    return datum | 0;
  },
  iota: function(length) {
