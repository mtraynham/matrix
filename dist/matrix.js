...
($traceurRuntime.createClass)(NDArray, {
  ...
  set data(data) {
    this.data_ = data ? ArrayUtils.fill(data) : data;
  },
  get size() {
    return this.size_;
  },
  ...
  transpose: function() {
    ...
    var shape = this.shape,
        stride = this.stride;
    axes = axes.map((function(axis, index) {
      return (axis === undefined) ? index : NumberUtils.nullToZero(axis);
    }));
    return new $NDArray(this.data, axes.map((function(axis) {
      return shape[axis];
  ...
  pick: function() {
    ...
    axes.forEach((function(axis, index) {
      if (typeof axis === 'number' && axis >= 0) {
        offset = NumberUtils.nullToZero(offset + stride[index] * axis);
      } else {
        a.push(shape[index]);
        b.push(stride[index]);
      }
...
($traceurRuntime.createClass)(ArrayUtils, {}, {
  ...
  fillIota: function(array) {
    return $ArrayUtils.fill(array, (function(i) {
      return i;
    }));
  },
